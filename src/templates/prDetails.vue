<template>
     <div style="min-height: 600px" >
        <el-card shadow="never" style="min-height: 400px">
            ...
            <div v-html="markdownBody" v-if="markdownBody" class="markdown-body" style="padding-top: 20px"></div>
            <div v-if="!markdownBody" style="padding: 20px 0px 20px 0px;text-align: center">
...
export default {
    ...
    methods:{
        ...
        async getProject(){
            ...
            this.markdownBody = markdown.render(BASE64.decode(data.content));
        }
    }
}
</script>
