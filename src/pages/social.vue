            ...
            <el-tabs v-model="activeTab" type="card" @tab-click="onSelect">
                        ...
                        <div v-if="followers.followers.length">
                            ...
                            <div style="text-align: center; margin-top: 10px">
                                <el-pagination
                                    ...
                                    :total="
                                        followers.query.pageNumber *
                                        followers.query.pageSize
                                    "
                                >
                                </el-pagination>
                            </div>
                ...
                >
                    <div v-loading="following.loading">
                        <div v-if="following.following.length">
                            <el-row style="min-height: 200px">
                                <el-col
                                    :span="8"
                            ...
                            <div style="text-align: center; margin-top: 10px">
                                <el-pagination
                                    ...
                                    :total="
                                        following.query.pageNumber *
                                        following.query.pageSize
                                    "
                                >
                                </el-pagination>
                            </div>
